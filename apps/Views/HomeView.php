<body>
    ...
    <div class="home-main-bg">
        <section class="why-features">
            <div class="why-features-container">
                <div class="why-feature-item">
                    <div class="why-feature-icon">
                        <!-- Fresh Products SVG -->
                        <svg width="64" height="64" fill="none" stroke="#ffe4a1" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 64 64">
                            <ellipse cx="32" cy="44" rx="20" ry="10" />
                            <ellipse cx="22" cy="34" rx="4" ry="4" />
                            <ellipse cx="32" cy="30" rx="6" ry="6" />
                            <ellipse cx="42" cy="34" rx="4" ry="4" />
                            <rect x="18" y="54" width="28" height="6" rx="1" />
                        </svg>
                    </div>
                    <div class="why-feature-title">SẢN PHẨM TƯƠI NGON</div>
                    <div class="why-feature-desc">Chúng tôi luôn sử dụng nguyên liệu tươi mới, đảm bảo chất lượng cho từng ly cafe và món ăn.</div>
                </div>
                <div class="why-feature-item">
                    <div class="why-feature-icon">
                        <!-- Skilled Chefs SVG -->
                        <svg width="64" height="64" fill="none" stroke="#ffe4a1" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 64 64">
                            <path d="M20 44V36a12 12 0 0 1 24 0v8" />
                            <rect x="24" y="44" width="16" height="10" rx="2" />
                        </svg>
                    </div>
                    <div class="why-feature-title">ĐỘI NGŨ PHA CHẾ TAY NGHỀ CAO</div>
                    <div class="why-feature-desc">Đội ngũ nhân viên chuyên nghiệp, tận tâm và giàu kinh nghiệm mang đến trải nghiệm tuyệt vời nhất.</div>
                </div>
                <div class="why-feature-item">
                    <div class="why-feature-icon">
                        <!-- Unique Recipes SVG -->
                    ...
                    <div class="why-feature-title">CÔNG THỨC ĐỘC ĐÁO</div>
                    <div class="why-feature-desc">Chúng tôi sáng tạo nhiều công thức cafe và đồ uống đặc biệt, chỉ có tại quán của chúng tôi.</div>
                </div>
            </div>
        ...
        <section class="section-products">
            <div class="section-title-small-row">
                <span class="section-title-diamond"></span>
                <span class="section-title-small">From Our Menu</span>
                <span class="section-title-diamond"></span>
            </div>
        ...
        <!-- End Why Choose Features Section -->
